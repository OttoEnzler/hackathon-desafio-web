...
function LugarPage() {  
    ...
    if (!lugar) {  
        return <p className="text-center text-xl mt-10">No se encontró información del lugar.</p>;  
    }  

    return (  
        <div className="max-w-4xl mx-auto p-6 bg-[#fde047] shadow-md rounded-lg">  
            ...
            <div className="space-y-2">
                ...
                <p className="text-gray-700 flex items-center">
                    {lugar.rating ? `Rating: ${lugar.rating} ` : 'Sin calificación'}
                    {lugar.rating && <StarIcon className="h-5 w-5 text-yellow-500 ml-1" />}
                </p>  
